...
describe InvoiceReport do # rubocop:disable Metrics/BlockLength
  subject { InvoiceReport.new(invoices, date_range) }
  let(:date_range) do
    DateRange.new(Date.new(2018, 10, 1), Date.new(2018, 10, 31))
  end
